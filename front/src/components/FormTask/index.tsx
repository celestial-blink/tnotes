        ...
        <form className="is__form w-full gap-3 flex flex-col text-lg min-w-[350px]">
            ...
            <div className="w-full">
                <fieldset className="wrap__input gap-2">
                    ...
                    <div className="flex flex-col">
                        <label className="label text-cyan-900" htmlFor="endDate">Fecha limite</label>
                        <input type="datetime-local" className="input" name="endDate" id="endDate" />
                    </div>

                    <label className=""> <input type="checkbox" name="" id="" /> <span>Completado</span> </label>
